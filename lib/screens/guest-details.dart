...
class CheckinButton extends StatefulWidget {
  Guest guest;
  Ticket ticket;
  CheckinButton(this.guest, this.ticket);

  @override
  _CheckinButton createState() => _CheckinButton(guest, ticket);
}
                          ...
                          isActive ? MaterialButton(
                            ...
                            onPressed: !this.isActive
                              ...
                              if (controller.text.isNotEmpty) {
                                final _bloc =
                                BlocProvider.of<GuestDetailsBloc>(
                                    context);
                                _bloc.add(SignWaiver(
                                    guest, ticket, true, controller.text));
...
MaterialButton buildCheckInButton(
    BuildContext context, Ticket ticket, Guest guest, TextEditingController controller, bool isActive) {
  final _bloc = BlocProvider.of<GuestDetailsBloc>(context);
...
//
// MaterialButton checkInButton(TextEditingController controller,
//     BuildContext context, Ticket ticket, Guest guest) {
//   return
// }

MaterialButton checkInButtonDisabled() {
  return MaterialButton(
      onPressed: null,
      disabledColor: Colors.black12,
      textColor: Colors.white,
      child:
          Text('Agree and Redeeem Ticket', style: appTheme.textTheme.button));
}
